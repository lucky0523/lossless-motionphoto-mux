...
- [3. 研究过程与踩过的坑](#3-研究过程与踩过的坑)
  ...
  - [坑 3：exiftool 会因为「只有一个 item 带 Padding」而崩溃](#坑-3exiftool-会因为只有一个-item-带-padding-而崩溃)
  - [坑 4（最大的坑）：ElementTree 把 xmlns 全提到根元素，小米认不出来](#坑-4最大的坑elementtree-把-xmlns-全提到根元素小米认不出来)
